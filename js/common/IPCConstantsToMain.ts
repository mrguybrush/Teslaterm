...
export const IPC_CONSTANTS_TO_MAIN = {
    ...
    requestSimulatedMidiDevices: makeKey<undefined>('request-simulated-midi-devices'),
    ...
    flightRecorder: {
        ...
        // TelemetryTab.saveExportedVideo for why moving those bytes around is worth avoiding.
        requestVideoSavePath: makeKey<string>('flight-session-video-save-request'),
    ...
    midiPlaylist: {
        ...
        loadArchiveFile: makeKey<string>('midi-playlist-load-archive-file'),
        loadPlaylistEntry: makeKey<number>('midi-playlist-load-playlist-entry'),
        ...
        requestPreviewFile: makeKey<string>('midi-playlist-request-preview-file'),
        requestSavedPlaylists: makeKey<undefined>('midi-playlist-request-saved'),
        resume: makeKey<undefined>('midi-playlist-resume'),
        savePlaylistAs: makeKey<string>('midi-playlist-save-as'),
...
export function getToMainIPCPerCoil(coil: CoilID) {
    ...
    return {
        ...
        sliders: {
            ...
            setOntimeFine: makeCoilKey<number>('slider-set-ontime-fine'),
