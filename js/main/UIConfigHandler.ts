...
function fixSyncedConfig(object: Partial<SyncedUIConfig>) {
    ...
    if (object.windowHeight === undefined) {
        object.windowHeight = 1000;
    }
    if (object.sliderSize === undefined) {
        object.sliderSize = 20;
    }
    if (object.voltagePhases === undefined) {
        object.voltagePhases = 1;
    }
    if (object.scopeBackgroundColor === undefined) {
        object.scopeBackgroundColor = '#f0f0f0';
    }
    if (object.scopeGridColor === undefined) {
