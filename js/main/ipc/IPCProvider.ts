...
import {MidiPlaylistIPC} from "./MidiPlaylistIPC";
...
export class IPCCollection {
    ...
    public readonly midiPlaylist: MidiPlaylistIPC;
    ...
    constructor(process: MainIPC) {
        ...
        this.midiPlaylist = new MidiPlaylistIPC(process);
